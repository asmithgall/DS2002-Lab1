...
#Call the procedure for the dates of rental transactions in the database, between May and August of 2005
CALL PopulateDateDimension('2005/05/01', '2005/08/25');
